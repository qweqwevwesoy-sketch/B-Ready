...
export function FAB({ onCategorySelect }: FABProps) {
  ...
  return (
    <>
      {/* Floating Action Button - Updated to match dashboard chatbox style */}
      <button
        onClick={() => setIsOpen(true)}
        className="fixed bottom-6 right-6 w-16 h-16 bg-blue-500 text-white rounded-full shadow-lg hover:bg-blue-600 hover:shadow-xl transform hover:scale-105 transition-all duration-200 z-50 flex items-center justify-center text-2xl font-bold"
